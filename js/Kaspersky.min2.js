function ajaxLoad(e) {
    if (!e.hasClass("loading")) {
        ...
        $.ajax({
            ...
            e.append(n),
            e.data("page", t + 1),
            e.trigger("ajaxLoadComplete")
        }).always(function() {
            e.find(".svg-preloader").remove(),
...
!function(e, t) {
    t(e).ready(function() {
        function n(e) {
            ...
            l ? (h.beta = s(-(e.beta - l.beta) / 10, 1) * d,
            h.gamma = s((e.gamma - l.gamma) / 10, 1) * d) : (p.off("mousemove", i),
            l = {
                beta: e.beta,
                gamma: e.gamma
            })
    ...
    e.trimText = function(e, t, n) {
        ...
        o.length > 1)
            ...
            for (o = e.split(" "); o.length > 0; ) {
                ...
                o.length > 0 && r.length > 1 && ["a", "the", "is", "of"].indexOf(r[r.length - 1].toLowerCase()) >= 0 && o.unshift(r.pop()),
                i.push(r.join(" "))
            }
        return i
    }
...
!function(e, t) {
    function n() {
        ...
        $(".transition-wrapper"));
        0 === o.length && (o = $("<div class='transition-wrapper'>"),
        e.append(o));
        ...
        this.fadeOut = function() {
            this.opened = !0,
            $.each(s, i(!1, c)),
            o.addClass("transition-wrapper_fade-out")
        }
        ,
...
!function(e, t) {
    ...
    function o() {
        for (var e = r(), t = 0; t < p.length; t++)
            p[t].css("height", 100 * e(t / (p.length - 1)) + "%")
    }
    function a(e, t) {
    ...
    for (var c, l = e(".mute-btn_false"), d = l.find("label"), u = [1, 2, 3, 7, 18, 11, 25, 13, 26, 47, 26, 18, 25, 11, 18, 7, 3, 2, 1], p = [], h = e(".sound", top.document), f = 0; f < u.length; f++) {
        ...
        p.push(m),
        m.appendTo(d).after(" ").css("height", u[f] / .47 + "%")
    }
    var g = function(e) {
...
function(e, t, n, i, o) {
    ...
    e.getHexaspherePopup = function(e, n, o) {
        ...
        a.localization("en"),
        o && (scriptMobile = i("#earth-mobile-tip[type='text/x-handlebars-template']"),
        ...
        {
            element: a.get(0),
            action: function(e) {//a && a.toggleClass("earth-popup_moving", !0 === e || "mousedown" === e)
            },
            close: function() {
    ...
    function a(e) {
        ...
        function o(n) {
            if (currentYear != n.data("year")) {
                ...
                r = !0) : r = !0,
                r && (t(n).addClass("active").siblings().removeClass("active"),
...
!function(e, t, n, i, o) {
    function a(o) {
        ...
        function r(i) {
            ...
            n(".addwork-link", o).attr("href", e.addwork_link(u)),
            v.addCommentForm(null, u))
        }
        function s(e) {
        ...
        o.on("modal-item:show  modal-item:hide", function(e) {
            m.always(function() {
                ...
                h.works_count > 0 && "modal-item:show" === e.type ? (_.attr("href", "prediction?brief_id=" + u),
...
!function(e, t, n, i, o) {
    ...
    function s(e) {
        function n(t, n) {
            c || (c = new PNRM.GUI,
            s = window.panoramaViewer = new PNRM.Player(e,c));
            var i = t.points;
            if (i) {
                if ("string" == typeof i) {
                ...
                t.points = [];
            d.finish().fadeIn(100),
            h.finish().fadeOut(100),
            s.createPanorama(t, function() {
                d.finish().fadeOut(100),
                n && n(),
                f || h.finish().fadeIn(100)
            }),
            l = s.VR
        }
        function o(e) {
            l.enableVR(e),
            s.fullscreenToggle(e),
            h.finish().hide()
        }
        function a() {
            Util.addEvent("up", m, r),
            Util.addEvent("move", m, function() {
                h.finish().fadeOut(),
                Util.removeEvent("down", m, a),
                r(),
                f = !0
            })
        }
        function r() {
            Util.removeEvent("up", m, r),
            Util.removeEvent("move", m)
        }
...
!function(e, t, n, o, a, r, s, c) {
    ...
    function d(e, t, n) {
        ...
        function o(t, n) {
            ...
            c !== t) {
                ...
                var u = e;
                i(u, !1, d + "point", t),
                i(u, !0, d + "concept-info", t),
                i(u, !0, "concept-name__line", t),
                clearTimeout(s),
    ...
    e.HexagonalMap = function(e, n, c, l) {
        function u() {
            ...
            for (var t = 1 / A.scale, n = 0; n < H.length; n++)
                H[n].scale(t)
        }
        function v(e, t) {
            E = t,
        ...
        function w(e) {
            console.debug(e),
            I.find(".city-name__city").html(e.location && e.location.city || "CITY"),
            I.find(".city-name__country").html(e.location && e.location.country || "COUNTRY"),
            S = e,
            y()
        }
        function b() {
        ...
        function x(e, n) {
            for (var i, o = e.data, a = e.width, r = e.height, s = -n.dx, c = -n.dy, d = Math.ceil(1.5 * n.width + l.offset), u = Math.ceil(n.height / 2 + l.offset), p = [], f = new t.Point(.5 * a,.5 * r), m = 999999, v = 0, w = c; w < r; w += u,
            v++)
                for (var b = 0, y = s + (1 & v) * d * .5; y < a; y += d,
                b++)
                    if (h(o, y, w, a)[3] >= g) {
        ...
        function M(e) {
            ...
            A.width = parseFloat(n.width),
            A.height = parseFloat(n.height);
            for (var i = [], o = 0; o < L.canvases.length; o++) {
                t = new r.Bitmap(L.canvases[o]),
                t.alpha = 0,
                O.addChild(t);
                var l = a.Deferred();
                s.to(t, .5, {
            ...
            $(i).then(function() {
                for (var e = Math.max(.08, Math.min(.2, 1 / H.length)), t = 0; t < H.length; t++)
                    H[t].show(.2 + t * e)
            })
        }
        function $(e) {
        ...
        var S, E, T, z = void 0, I = e.closest(".kaspersky-app").find(".city-name"), D = Handlebars.compile(e.find('[type="text/x-handlebars-template"]').html()), O = new r.Stage(n), P = new r.Stage(c), L = new p(5), q = function(e, t) {
        ...
        a(o.documentElement).on("resize:after", function() {
            A.scale = parseFloat(a(this).css("fontSize")) / 18,
            u()
        }),
...
function(e, t, n) {
    ...
    function o(o) {
        ...
        function s(i, a) {
            function r(e, n) {
                c = n,
                t.Image(i).rotate(l[a]).get(function(e, t) {
                    e || (d.off("user-pic-crop:save").userPicCrop(t, o.data("title")).on("user-pic-crop:save", s),
                    p.val(""))
                })
            }
            function s(e, n) {
                ...
                t.Image(i).rotate(l[a]).crop(s * c.width, d * c.height, u * c.width, p * c.height).get(function(e, t) {
                    if (e)
                        ...
                        i.getContext("2d").drawImage(t, 0, 0, t.width, t.height, a * (n.x < 0 ? 1 - h : 0), s * (n.y < 0 ? 1 - f : 0), a * h, s * f),
                        o.trigger("upload-image:crop", i)
                    }
                })
            }
            var c, d = e(".js-user-pic-block");
            d.is(":visible") || peppers.modal("user-pic-crop", n.hash),
            t.getInfo(i, r)
        }
        var c = 1
          , l = {
        ...
        o.append(p),
        t.event && t.event.on(p.get(0), "change", a),
        function() {
...
!function(e, t, n) {
    function i(t) {
        t = encodeURIComponent(t).replace(/\%2F/g, "%5C"),
        e.location = o + t
    }
...
function() {
    ...
    function n(e, t) {
        ...
        function o() {
            peppers.checkMobile.css.isMobile() || (d = e.offset().top,
            l = m.offset().top,
            p && p.length > 0 && p.data("bottom", void 0)),
            a(h)
        }
        function a(t, n) {
            m.removeClass("paginator_no-next paginator_no-prev"),
            p && p.removeClass("my-discussion_hide"),
            g.toggle(!(p && p.length > 0)),
            p && p.length > 0 && (t >= p.length && (t = p.length,
            n = !0),
        ...
        function s(e, t) {
            ...
            if (t)
                for (; a-- > 0; )
                    n = p.eq(a),
                    (i += n.outerHeight()) < l - d && (h = a,
                    o = o.add(n));
            for (a = e; a < p.length; a++)
                n = p.eq(a),
                (i += n.outerHeight()) < l - d && (f = a,
                o = o.add(n));
            console.debug(o),
            o.removeClass("my-discussion_hide"),
            p.not(o).addClass("my-discussion_hide"),
            m.toggleClass("paginator_no-next", f >= p.length - 1),
...
function(e, t, n) {
    function i(n) {
        ...
        function f() {}
        var m, g = "250", v = "100", w = {}, b = n.find(".user-pic-block__image-wrap"), y = n.find(".user-pic-block__canvas");
        e(".user-pic-crop__dot", b).on("touchstart  mousedown", d),
        e(".js-pic-save", n).on("click", h),
        e(".user-pic-block__image-wrap").on("wheel", l),
        b.on("touchstart  mousedown", p);
        var k, _, x = n.find(".select-file").uploadImage().on("upload-image:crop", o), C = n.find(".js-viewer");
        n.on("modal-item:hide", f),
        e(t).on("hashchange", i);
        var j;
        this.init = function(t, i) {
            if (x.data("title", i),
            !t)
                return j && j.off().remove(),
                j = void 0,
                !1;
            n.toggleClass("user-pic-crop_edit", !!(t && !0 !== t || j)),
            !0 !== t && (j && j.off().remove(),
            j = t && e(t).appendTo(y).addClass("user-pic-crop__target"),
            k = {
                left: -2e3,
                right: -2e3,
                top: -2e3,
...
!function(e, t, n) {
    ...
    $(n).on("click", ".js-tooltip-menu", function() {
        ...
        ($(t).width() >= 1e3 || e.hasClass("mobile-event")) && (e.hasClass("open") ? (r(!1),
        e.removeClass("open").fadeOut(200)) : (r(!0),
...
!function(e, t) {
    $(t).on("click", ".js-search-btn", function(e) {
        ...
        $(".js-search-form").hasClass("active") && ($(".js-search-form input[type=text]").get(0).focus(),
        $("#k-menu-toggle").prop("checked") && ($("#k-menu-toggle").prop("checked", !1),
...
function(e, t, n, i) {
    e.fn.welcome = function() {
        ...
        if (0 === this.length || e.cookie("visited") || d)
            o();
        else {
            e.cookie("visited", "1", {
                expires: 3650,
...
function(e, t, n, i, o, a, r) {
    function s() {
        ...
        t.sortRedrawList = function(e, n, i, a, r) {
            ...
            a({
                ...
                s.html(i),
                s.data("action", t.getUrlMethod(e, {
                    sort: e,
                    type: n
                })),
        ...
        o(function() {
            function e(e) {
                ...
                o(".timeline-new").pepTimeline(i, e).on("timeline:change", function(e, t) {
                    o.cookie(n, t, {
                        path: "/",
    ...
    function c(e, t, i, a, r) {
        ...
        var ajaxUrl = e;
        return p = langUrl + "api/" + (w.hasOwnProperty(e) ? w[e] + "?" + Date.now() : "" + "?" + Date.now()),
        function(n, r, l) {
            function u(e, t) {
                for (var n in e)
    ...
    function() {
        ...
        function n() {
            ...
            m.toggleClass("landscape", r && e.checkMobile.isMobileOrTablet() && screen.width < 1280);
            var l = {
                width: n,
                height: i
            };
...
function() {
    ...
    function t() {
        ...
        e = setInterval(function() {
            earthDemo.data && (earthDemo.startAnimation(),
            clearInterval(e))
        }, 100)
    }
    ...
    $(document).on("click", ".js-toggle-demo", function() {
        if ($(".js-toggle-map").eq(0).is(".is-active") || $(".js-toggle-demo").eq(0).is(".is-active"))
            if ($(".js-toggle-map").removeClass("is-active toogle-page__link--active"),
            ...
            "知名景点" === window.YEAR_ID)
                ...
                var e = setInterval(function() {
                    "知名景点" === window.YEAR_ID ? (clearInterval(e),
                    setTimeout(t, 2e3)) : $('.js-timeline-item[data-year="知名景点"]').eq(0).trigger("click")
                }, 1e3)
            }
        else
            $(".js-toggle-feed").eq(0).is(".is-active") && (sessionStorage.setItem("demoIsOn", "true"),
            $(".js-toogle-main-page.js-toggle-map").eq(0).trigger("click"))
    }),
    "true" === sessionStorage.getItem("demoIsOn") && (sessionStorage.setItem("demoIsOn", ""),
    setTimeout(function() {

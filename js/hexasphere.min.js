...
function Planet(e, t, a, i) {
	...
	this.update = function() {
		...
		if (this.particles && (this.particles.rotation.y += .001 * h.speedMultiple), this.planetPointed.update(), this.updateBg && this.updateBg(), z) {
			...
			r.y = -(r.y - 1) / 2 * (window.earthDemo && window.earthDemo.createMode ? document.documentElement.offsetHeight: window.innerHeight),
...
function(e) {
	function t() {
		var e = !(window.innerWidth > 1e3) || window.earthDemo && window.earthDemo.running ? window.innerWidth: window.innerWidth ,
...
Planet.prototype.drawSputniks = function() {
	this.sputniks = [];
	this.addSputnik("https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@latest/assets/earth/space_a.js", 1.2 * this.radius, this.container, new THREE.Vector3( - .5, 0, 0)),
	this.addSputnik("https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@latest/assets/earth/space_a.js", 1.1 * this.radius, this.container, new THREE.Vector3( - .7, 2, 0)),
	this.addSputnik("https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@latest/assets/earth/space_c.js", 1.25 * this.radius, this.container, new THREE.Vector3(.6, 3, -1.2))
},
...
var PlanetData = function() {
	var e = this;
	this.textures_path = "https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@latest/assets/earth/",
	this.YEAR = null,
	this.YEAR_ID = null,
	this.years={},
	/*this.years = {

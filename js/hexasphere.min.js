...
Planet.prototype.drawSputniks = function() {
	this.sputniks = [];
	this.addSputnik("https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@1.0.3/assets/earth/space_a.js", 1.2 * this.radius, this.container, new THREE.Vector3( - .5, 0, 0)),
	this.addSputnik("https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@1.0.3/assets/earth/space_a.js", 1.1 * this.radius, this.container, new THREE.Vector3( - .7, 2, 0)),
	this.addSputnik("https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@1.0.3/assets/earth/space_c.js", 1.25 * this.radius, this.container, new THREE.Vector3(.6, 3, -1.2))
},
...
var PlanetData = function() {
	var e = this;
	this.textures_path = "https://cdn.jsdelivr.net/gh/luoxsgit/threeEarth@1.0.3/assets/earth/",
	this.YEAR = null,
	this.YEAR_ID = null,
	this.years={},
	/*this.years = {

...
function Planet(e, t, a, i) {
	...
	this.update = function() {
		...
		if (this.particles && (this.particles.rotation.y += .001 * h.speedMultiple), this.planetPointed.update(), this.updateBg && this.updateBg(), z) {
			...
			r.y = -(r.y - 1) / 2 * (window.earthDemo && window.earthDemo.createMode ? document.documentElement.offsetHeight: $("div.w-code").height()),
...
function(e) {
	function t() {
		var e = !($("div.w-code").width() > 1e3) || window.earthDemo && window.earthDemo.running ? $("div.w-code").width(): $("div.w-code").width() ,
		t = $("div.w-code").height();
		window.earthDemo && window.earthDemo.createMode && (e = !(document.documentElement.offsetWidth > 1e3) || window.earthDemo && window.earthDemo.running ? document.documentElement.offsetWidth: document.documentElement.offsetWidth - 302, t = document.documentElement.offsetHeight),
	...
	var d = l.domElement;
	r.append(d);
	var u = n.camera = new THREE.PerspectiveCamera(60, window.earthDemo && window.earthDemo.createMode ? document.documentElement.offsetWidth / document.documentElement.offsetHeight: $("div.w-code").width() / $("div.w-code").height(), .1, 700);
...
Utils.getEventCursorPositionOrientation = function(e, t) {
	...
	t.x = t.x / $("div.w-code").width() * 2 - 1,
	t.y = -t.y / $("div.w-code").height() * 2 + 1
},
